//
//  BatchSelPatentTableViewCell.m
//  HGIntellectualProperty
//
//  Created by 耿广杰 on 2017/9/18.
//  Copyright © 2017年 HG. All rights reserved.
//

#import "BatchSelPatentTableViewCell.h"

@interface BatchSelPatentTableViewCell()
...
@property (weak, nonatomic) IBOutlet UIImageView *selStatusImage;


@end

@implementation BatchSelPatentTableViewCell
{
...
-(void)setModel:(PatentModel *)model
{
    ...
    if (model.selStatus) {
        self.selStatusImage.image = [UIImage imageNamed:@"selected"];
    }
    else
    {
        self.selStatusImage.image = [UIImage imageNamed:@"disSelected"];
    }
}
